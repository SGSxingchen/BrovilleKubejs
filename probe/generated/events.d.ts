...
declare function onForgeEvent(name: "io.github.lightman314.lightmanscurrency.common.events.GetDefaultMoneyDataEvent", handler: (event: Internal.GetDefaultMoneyDataEvent) => void);
...
declare function onForgeEvent(name: "net.minecraftforge.event.entity.player.PlayerInteractEvent$LeftClickEmpty", handler: (event: any) => void);
...
declare function onForgeEvent(name: "org.orecruncher.lib.events.BlockUpdateEvent", handler: (event: Internal.BlockUpdateEvent) => void);
...
declare function onForgeEvent(name: "org.orecruncher.sndctrl.events.AudioEvent$MusicFadeAudioEvent", handler: (event: Internal.AudioEvent$MusicFadeAudioEvent) => void);
